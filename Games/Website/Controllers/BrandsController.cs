    ...
    public class BrandsController : Controller
    {
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // make the request
                HttpResponseMessage response = await client.GetAsync("brands/getbyid?=" + id);
        ...
        public async Task<ActionResult> Create(BrandVM brandVM)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    // make the request
                    HttpResponseMessage response = await client.PostAsync("brands/save", byteContent);
        ...
        public async Task<ActionResult> Delete(int id, FormCollection collection)
        {
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    // make the request
                    HttpResponseMessage response = await client.DeleteAsync("brands/delete?=" + id);
                }
